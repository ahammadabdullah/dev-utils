...
const GitignoreGenerator: React.FC = () => {
  ...
  const renderCategorySection = (
    category: keyof typeof templatesByCategory
  ) => {
              ...
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["react", "node", "windows", "vscode"])
                    }
                  >
                    React App
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["nextjs", "node", "windows", "vscode"])
                    }
                  >
                    Next.js App
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["vue", "node", "windows", "vscode"])
                    }
                  >
                    Vue.js App
                  </Button>
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["laravel", "php", "windows", "vscode"])
                    }
                  >
                    Laravel
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["django", "python", "windows", "vscode"])
                    }
                  >
                    Django
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["fastapi", "python", "windows", "vscode"])
                    }
                  >
                    FastAPI
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["flask", "python", "windows", "vscode"])
                    }
                  >
                    Flask
                  </Button>
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      quickStart(["express", "node", "windows", "vscode"])
                    }
                  >
                    Express.js
                  </Button>
            ...
            <div className="space-y-8">
              {Object.keys(categoryLabels).map((category) =>
                renderCategorySection(
                  category as keyof typeof templatesByCategory
                )
              )}
            </div>
          </ScrollArea>
          ...
          {generatedContent && generatedContent.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                Go to the Templates tab, select some templates or add custom
                rules, then click "Generate .gitignore".
              </p>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (generatedContent && generatedContent.length > 0) {
                      ...
                      toast.error(
                        "Please select templates or add custom rules first."
                      );
                    }
                  }}
                  disabled={
                    selectedTemplates.length === 0 && !customRules.trim()
                  }
                >
                  Try Generate
                </Button>
